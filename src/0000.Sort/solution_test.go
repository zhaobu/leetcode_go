...
func TestHeapSort(t *testing.T) {
	//	测试用例
	cases := []*Case{
		{name: "test 1", input: &Input{nums: []int{49, 38, 65, 97, 76, 13, 27, 49}}, expect: []int{13, 27, 38, 49, 49, 65, 76, 97}},
		{name: "test 2", input: &Input{nums: []int{5, 7, 8, 3, 1, 2, 4, 6}}, expect: []int{1, 2, 3, 4, 5, 6, 7, 8}},
		{name: "test 3", input: &Input{nums: []int{40, 100, 9, 5, -2, 3, 2, -7, 2}}, expect: []int{-7, -2, 2, 2, 3, 5, 9, 40, 100}},
		{name: "test 4", input: &Input{nums: []int{42, 9, 5, -2, 3, 2, -6, 2}}, expect: []int{-6, -2, 2, 2, 3, 5, 9, 42}},
		{name: "test 5", input: &Input{nums: []int{-9, 100, 0, 2, 1, 11, 7, 4}}, expect: []int{-9, 0, 1, 2, 4, 7, 11, 100}},
		{name: "test 6", input: &Input{nums: []int{299, 10, -5, -3, -3, 2, -3, 5}}, expect: []int{-5, -3, -3, -3, 2, 5, 10, 299}},
	}
...
func TestCountingSort(t *testing.T) {
	...
	cases := []*Case{
		...
		{name: "test 2", input: &Input{nums: []int{49, 38, 65, 97, 76, 13, 27, 878, 49}}, expect: []int{13, 27, 38, 49, 49, 65, 76, 97, 878}},
		{name: "test 3", input: &Input{nums: []int{5, 7, 8, 3, 1, 2, 4, 6}}, expect: []int{1, 2, 3, 4, 5, 6, 7, 8}},
		{name: "test 4", input: &Input{nums: []int{5, 7, 7, 7, 8, 3, 1, 2, 4, 6}}, expect: []int{1, 2, 3, 4, 5, 6, 7, 7, 7, 8}},
	}
